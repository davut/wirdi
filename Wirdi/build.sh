...
ARCHIVE_ARM="$BUILD_DIR/Wirdi-arm64.xcarchive"
ARCHIVE_X86="$BUILD_DIR/Wirdi-x86_64.xcarchive"
APP_NAME="Wirdi.app"
...
xcodebuild archive \
  -project "$PROJECT_DIR/Wirdi.xcodeproj" \
  -scheme "$SCHEME" \
...
echo "   DMG:  $DMG_PATH"
echo ""
lipo -info "$OUTPUT_APP/Contents/MacOS/Wirdi"
